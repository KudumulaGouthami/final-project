...
quizzes = {
    "Python": [
        ...
        {"q": "Python is a __ language.", "options": ["Low level", "High level", "Machine", "Assembly"], "answer": "High level"},
    ...
    "Java": [
        {"q": "Java is a _ language.", "options": ["Compiled", "Interpreted", "Both", "None"], "answer": "Both"},
        ...
        {"q": "Java is _ independent.", "options": ["Platform", "Machine", "Device", "None"], "answer": "Platform"}
    ],
